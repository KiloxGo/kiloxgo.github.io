...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/kg-avatar.png',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'Kilox',
  bio: '#00BFFF',
  links: [
    {
    ...
    },
    {
      ...
      url: 'https://steamcommunity.com/profiles/76561199387737754',
    },
    {
      name: 'GitHub',
